...
class Sm_PageBuilder_Block_Adminhtml_Pagebuilder_Form_Renderer_Fieldset_Addwidget extends Mage_Adminhtml_Block_Template implements Varien_Data_Form_Element_Renderer_Interface {
    protected $_element;
