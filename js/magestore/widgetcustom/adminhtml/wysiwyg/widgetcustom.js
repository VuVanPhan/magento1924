...
var WysiwygWidgetCustom = {};
WysiwygWidgetCustom.Widget = Class.create();
WysiwygWidgetCustom.Widget.prototype = {

    initialize: function(formEl, widgetEl, widgetOptionsEl, optionsSourceUrl, widgetTargetId) {
        $(formEl).insert({bottom: widgetCustomTools.getDivHtml(widgetOptionsEl)});
        this.formEl = formEl;
    ...
    widgetsAction : function(widgetEl ){
        ...
        jQuery(".wgc-wg-button > div", $wwidgets).click(function(){
        ...
        new Ajax.Request(this.optionsUrl,
            {
                ...
                onSuccess: function(transport) {
                    try {
                        widgetCustomTools.onAjaxSuccess(transport);
                        this.switchOptionsContainer();
                        if ($(optionsContainerId) == undefined) {
                            this.widgetOptionsEl.insert({bottom: widgetCustomTools.getDivHtml(optionsContainerId, transport.responseText)});
...
WysiwygWidgetCustom.chooser = Class.create();
WysiwygWidgetCustom.chooser.prototype = {
        ...
        new Ajax.Request(this.chooserUrl,
            {
                ...
                onSuccess: function(transport) {
                    try {
                        widgetCustomTools.onAjaxSuccess(transport);
                        this.dialogContent = widgetCustomTools.getDivHtml(responseContainerId, transport.responseText);
                        this.openDialogWindow(this.dialogContent);
                    } catch(e) {
                        alert(e.message);
                    }
